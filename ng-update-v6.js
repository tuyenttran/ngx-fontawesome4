/**
 * Source: https://gist.github.com/leo6104/b4a2da0863d3c5b1877860d62464c706
 ...
 *
 * Or add this to package.json and execute
 * "update-cli": " ng update @angular/cli --from=1.5.4 --to=7.0.1 -migrate-only",
 **/
const fs = require('fs');
